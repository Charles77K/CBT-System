...
import { useFetchExams } from "../../services/Tanstack";
...
export default function CreateQuestion() {
	...
	const [selectedInput, setSelectedInput] = useState(initialForm);
	...
	const { mutate, isPending } = useMutation({
		mutationFn: ({ data, id }) => postData(`/questions/${id}/`, data),
		onSuccess: (response) => {
	...
	const { mutate: createOptions } = useMutation({
		mutationFn: ({ questionId, options }) =>
			Promise.all(
	...
	const createOptionsForQuestion = (questionId) => {
